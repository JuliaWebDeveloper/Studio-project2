        ...
        <div className='question-container'>
          ...
          <Accordion className='main-accordion' flush>
            <Accordion.Item eventKey="0">
              <Accordion.Header>Этапы работы со мной</Accordion.Header>
                <Accordion.Body>
                  <ul>
            ...
            <Accordion.Item eventKey="1">
              <Accordion.Header>Подготовка к фотосессии</Accordion.Header>
                <Accordion.Body>
            ...
            <Accordion.Item eventKey="2">
              <Accordion.Header>Как заказать фотосессию</Accordion.Header>
                <Accordion.Body>
